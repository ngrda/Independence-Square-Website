...
function extractStreetName(address) {
    // Quita números iniciales, comas, guiones y el prefijo direccional (N./S./E./W.)
    // para quedarnos solo con el nombre de la calle, ej: "112 W. Lexington Avenue" -> "Lexington Avenue"
...
function getBuildingsSortedByStreet() {
    return [...buildingsDatabase].sort((a, b) => {
        ...
        // Dentro de la misma calle, ordena por número de dirección ascendente
